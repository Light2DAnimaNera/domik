...
- `/balance` — показывает остаток средств и сегодняшние траты. В ответе используется эмодзи \U0001F4B3, обе суммы округляются вверх до двух знаков после запятой и сопровождаются символом 🝣.
