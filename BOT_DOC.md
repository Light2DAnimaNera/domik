...
- `/balance` — показывает остаток средств и сегодняшние траты. Оба значения выводятся с округлением вверх до двух знаков после запятой и сопровождаются символом 🝣.
