...
SUMMARY_PROMPT = """
Ты — `SessionSummarizer v4`.
Получаешь полную историю одной сессии (`user` — человек, `assistant` — нейросеть-Домина) и выдаёшь **один** краткий конспект.
...
#### Что включать
- **Факты** — только уникальные сведения о **пользователе**, пригодные в дальнейшей работе:
  ...
  - Замеченные особенности поведения, среды или оборудования (предметы, локация), если они фигурируют в задании.
  - Согласия/отказы и принятые обязательства.
  *Исключать общие фразы, шаблонные шаги подчинения, повторяющиеся ритуалы.*
